...
def bandplot(datafile, fermi, symmetryfile, subplot, colour, highsympoints, title):
    ...
    for j in temp:  # This is the high symmetry lines
        ...
        subplot.text(j, axis[2] - 2 * Fermi, highsympoints[val], va='center', ha='center', fontsize=12)
        val += 1
    ...
    subplot.text((axis[1] - axis[0]) / 2.0, axis[3] + 2 * Fermi + 1, title, va='center', ha='center', fontsize=20)
